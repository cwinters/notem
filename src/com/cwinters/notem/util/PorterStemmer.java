/*
   ...
   See also: http://www.tartarus.org/martin/PorterStemmer/def.txt
   See also: http://www.muscat.com/~martin/stem.html
   See also: http://svn.sourceforge.net/viewvc/exist/trunk/eXist-1.0/src/org/exist/util/PorterStemmer.java?view=log
...
public class PorterStemmer
{
 ...
 m() > 0. */
     ...
     * @return whether process would result in different word
     */
     ...
     *
     * @param wordBuffer string to pull subset from to stem
     * @param offset start of subset string to stem
     * @param wordLen finish of subset string to stem
     * @return whether process would result in different word
     */
